...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0002_remove_subject_class_group_remove_subject_teacher_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='studentmark',
            name='term',
            field=models.CharField(blank=True, choices=[('Term 1', 'Term 1'), ('Term 2', 'Term 2'), ('Term 3', 'Term 3')], db_index=True, max_length=20, null=True),
        ),
        migrations.AddField(
            model_name='studentmark',
            name='department',
            field=models.ManyToManyField(blank=True, related_name='marks', to='core.department'),
        ),
    ]
